...
exports.transformSources = (args) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield sorcery_1.remapSourceMap(umdFile);
    // 6. UMD: Minify
    log.info('Minifying UMD bundle');
    const minUmdFile = yield uglify_1.minifyJsFile(umdFile);
